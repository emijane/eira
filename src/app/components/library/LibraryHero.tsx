...
export default function LibraryHero() {
    return (
        <section className="relative overflow-visible rounded-[2rem] border border-brand-ink/10 bg-[linear-gradient(180deg,#fffefc_0%,#ffffff_100%)] px-6 py-8 shadow-[0_28px_90px_-42px_rgba(43,37,57,0.18)] sm:px-8 lg:px-10 lg:py-10">
                ...
                <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_260px] lg:items-start">
                    <div>
                        <div className="flex flex-wrap items-center gap-3">
                            <span className="inline-flex items-center rounded-full border border-brand-ink/15 bg-brand-ink px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.06em] text-white shadow-[0_14px_30px_-20px_rgba(43,37,57,0.55)]">
                    ...
                    <div className="hidden lg:block">
                        <div className="rounded-[1.75rem] border border-brand-ink/15 bg-brand-ink p-4 shadow-[0_24px_44px_-30px_rgba(43,37,57,0.28)]">
                            <div className="rounded-[1.25rem] border border-brand-ink/12 bg-[linear-gradient(135deg,rgba(239,200,200,0.46)_0%,rgba(186,224,218,0.38)_34%,rgba(238,239,200,0.36)_68%,rgba(196,181,253,0.18)_100%)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
                                <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-brand-mauve">
                                    Featured Lens
                                </p>
                                ...
                                <div className="mt-5 flex flex-wrap gap-2">
                                    <span className="rounded-full border border-brand-ink/15 bg-white/82 px-3 py-1 text-xs font-medium text-brand-ink shadow-[0_10px_18px_-16px_rgba(43,37,57,0.45)]">
                                        UI Kits
                                    </span>
                                    <span className="rounded-full border border-brand-ink/15 bg-white/82 px-3 py-1 text-xs font-medium text-brand-ink shadow-[0_10px_18px_-16px_rgba(43,37,57,0.45)]">
                                        Frameworks
