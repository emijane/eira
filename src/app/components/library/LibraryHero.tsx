                ...
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1.35fr)_320px] lg:items-start">
                    <div>
                        <div className="flex items-center gap-4">
                            <span className="inline-flex items-center rounded-full border border-brand-ink/10 bg-white/88 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-brand-haze">
